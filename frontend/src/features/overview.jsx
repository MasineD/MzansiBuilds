  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-black py-8 px-4">
      ...
      <div className="overview-content flex flex-col gap-2">
        ...
        <div className="recent-projects-side h-[15%]">
          ...
          {myProjects.length === 0 ? (
            ...
            <div className="relative h-full">
              {/* Faded ends overlay - left */}
              {/* <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-green-900 to-transparent z-10 pointer-events-none"></div> */}
          
              {/* Faded ends overlay - right */}
              {/* <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-green-900 to-transparent z-10 pointer-events-none"></div> */}
          
              {/* Horizontal carousel container */}
              <div className="recent-projects-list flex overflow-x-auto gap-4 pb-4 hide-scrollbar snap-x snap-mandatory h-full">
                {myProjects.map(project => {
                  return (
                    <div key={project.id} className="recent-project-card bg-white rounded-xl p-4 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 min-w-[300px] flex-shrink-0 snap-start">
                      <div className="project-card-header">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className='text-lg font-semibold text-gray-800'>{project.title}</h3>
                        </div>
        ...
        <div className="community-projects-side" style={{ height: '80%', overflowY: 'auto' }}>
          <div className="section-header mb-6">
