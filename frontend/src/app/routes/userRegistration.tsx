                ...
                <form className="loginCard space-y-5">       {/*card heading */}
                    ...
                    {!isLogin && (
                        <div className="firstName">
                            ...
                            <input type="text" className="w-full px-4 py-3  border rounded-lg" placeholder='Sibusiso Ndlomo' required />
                        </div>
                   ...
                   {/* ----------- Footer section for the sign-in page ------------*/}
                    ...
                    {!isLogin && (
                        <div>
                            <button type='submit' disabled={loading} className="w-full text-white py-3 rounded-lg font-semibold bg-green-500 hover:cursor-pointer hover:bg-[#00ff00] hover:shadow-[4px_4px_10px_0px_#00ff00] transition-shadow duration-300 hover:scale-105">
                            Sign Up
                        </button>
                        <p className="accountExistence">
