    ...
    <div className="min-h-screen">
      ...
      <section id="homeSection"className="landingPage_Section relative h-screen w-full flex items-center justify-center my-10">
        ...
        <div className='flex flex-col-2 sm:gap-[3vw] md:gap-[5vw] lg:gap-[8vw]'>
            ...
            <button onClick={() => navigate('/signin')} className="bg-green-500 text-white px-10 py-4 rounded-md text-lg font-medium hover:bg-[#00ff00] hover:shadow-[4px_4px_10px_0px_#00ff00] transition-shadow duration-300 hover:scale-105 hover:cursor-pointer">
                Get Started
            </button>
            </div>
